        ...
        <div className="mb-10 flex items-center justify-between gap-8">
          {user ? (
            <Button
              asChild
              variant="ghost"
              className="px-0 font-mono text-xs uppercase tracking-[0.16em] text-neutral-500 hover:bg-transparent hover:text-[var(--color-primary)]"
            >
              <Link href="/orders">
            ...
            <section className="border border-border bg-card px-6 py-6 shadow-[0_0_0_1px_rgba(0,0,0,0.03)]">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-3 flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
                          <span className="rounded-full border border-border px-3 py-1 font-mono uppercase tracking-[0.12em] text-[var(--color-primary)]">
              ...
              <div className="mt-8 border-t border-border pt-6">
                ...
                <div className="flex justify-between border-t border-border pt-5">
                  <span className="font-mono text-2xl font-bold uppercase tracking-[0.14em] text-[var(--color-primary)]">
                    Total
                  </span>
