  ...
  return (
    <div className="mt-5 space-y-14 text-foreground">
      ...
      <section className="space-y-6">
        <h2 className="text-xl font-bold uppercase tracking-wide text-[var(--color-primary)]">
          Security
        </h2>
        ...
        <div className="border border-border bg-card">
          <div className="flex items-center justify-between px-8 py-8">
            ...
            <label className="relative inline-flex cursor-pointer items-center">
              ...
              />
              <span className="h-5 w-10 rounded-full border border-border bg-muted transition peer-checked:border-[var(--color-primary)] peer-checked:bg-[var(--color-primary)]" />
